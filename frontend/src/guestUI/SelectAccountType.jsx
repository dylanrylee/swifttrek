                ...
                <div className={styles.contentBox}>
                    ...
                    <div className={styles.buttonContainer}>
                        ...
                        <button 
                            ...
                            onClick={() => window.location.href = '/businessUI/loginbusiness.html'}
                        >
                            Business
                        </button>
                        <button 
                            className={styles.adminaccountButton} 
                            onClick={() => window.location.href = '/adminUI/login_admin.html'}
                        >
                            Admin
                        </button>
                    </div>
